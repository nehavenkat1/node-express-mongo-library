...
exports.author_create_post = [
    ...
    .isAlphanumeric().withMessage('First name has non-alphanumeric char.'),
    body('family_name').trim().isLength({min: 1}).escape().withMessage('Family name is reqired.')
    .isAlphanumeric().withMessage('Family name is non-alphanumeric char.'),
